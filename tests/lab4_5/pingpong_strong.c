...
int main() {
    ...
    if (isSon) {
        ...
        ptr[300] = who;
        ptr[300] = i;
        // The answer was provided as if i is written before son finishes recv,
        // so we do it earlier to avoid sched racing. To enhance the case, we
        // may modify ptr[300] after the son sends an ack.
