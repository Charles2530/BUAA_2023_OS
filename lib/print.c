...
static void
print_num(fmt_callback_t, void*, unsigned long, int, int, int, int, char, int);
...
void vprintfmt(fmt_callback_t out, void* data, const char* fmt, va_list ap) {
    ...
    for (;;) {
        ...
        /* Exercise 1.4: Your code here. (t/8) */
        if (*fmt == '\0') {
            break;
        }
        //
        ...
        switch (*fmt) {
            ...
            case 'D':
                ...
                /*
                 * Refer to other parts (case 'b', case 'o', etc.) and func
                 * 'print_num' to complete this part. Think the differences
                 * between case 'd' and the others. (hint: 'neg_flag').
                 */
                ...
                print_num(out, data, num, 10, neg_flag, width, ladjust, padc,
                          0);
                //
                break;
...
void print_char(fmt_callback_t out,
                void* data,
                char c,
                int length,
                int ladjust) {
...
void print_str(fmt_callback_t out,
               void* data,
               const char* s,
               int length,
               int ladjust) {
...
void print_num(fmt_callback_t out,
               void* data,
               unsigned long u,
               int base,
               int neg_flag,
